...
import { Mt as ChevronRight, ft as FileQuestionMark } from "../_libs/lucide-react.mjs";
import { g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as Footer } from "./Footer-ltp81XHe.mjs";
import { t as MarketingHeader } from "./MarketingHeader-CTcyVmuL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ressources-DwljFJuR.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Des guides et conseils pour aider les agences à mieux utiliser Sortlist."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileQuestionMark, {
								className: "h-8 w-8 text-muted-foreground",
								strokeWidth: 1.4
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-[14px] font-semibold",
								children: "Aucune ressource publiée pour le moment"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1.5 max-w-[360px] text-[13px] leading-[1.5] text-muted-foreground",
								children: "Cette section sera alimentée prochainement avec des guides et conseils pratiques."
							})
						]
					}),
