...
import { A as Scale, G as Megaphone, H as MessageSquare, Lt as ChartColumn, Qt as ArrowRight, R as Palette, Ut as Briefcase, b as Star, bt as Compass, i as Wallet, nn as Activity, o as UsersRound, r as Workflow, ut as Folder, x as Sparkles, xt as CodeXml } from "../_libs/lucide-react.mjs";
import { g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as getAgencyDashboardOverview, t as EmptyState } from "./EmptyState-CjCsYQbe.mjs";
...
import { t as getAgencyProjects } from "./agency-projects.service-phWEnAJj.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/agence.tableau-de-bord-wM5S36WI.js
...
function StarRow({ value }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: Array.from({ length: 5 }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, {
			className: "h-3 w-3 " + (i < rounded ? "fill-primary text-primary" : "text-border"),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: isStatsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatSkeleton, { count: 4 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StatGrid, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
							...
							suffix: "/5",
							footer: stats.averageRating !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StarRow, { value: stats.averageRating }) : null
						})
					] })
				}),
							...
							children: activities.map((activity) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "absolute -left-[25px] top-1 flex h-5 w-5 items-center justify-center rounded-full border-2 border-background bg-primary/10 text-primary",
...
function QuickAccess({ icon: Icon, label, description, to }) {
