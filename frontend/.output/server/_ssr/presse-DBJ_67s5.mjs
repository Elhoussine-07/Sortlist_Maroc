...
//#region node_modules/.nitro/vite/services/ssr/assets/presse-DBJ_67s5.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Pour toute demande presse, contactez notre équipe directement."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Aucune mention presse pour le moment"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1.5 max-w-[360px] text-[13px] leading-[1.5] text-muted-foreground",
								children: "Pour toute question presse, écrivez-nous à contact@sortlistpro.com."
							})
						]
					}),
