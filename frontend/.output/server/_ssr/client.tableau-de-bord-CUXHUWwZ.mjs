...
import { F as Plus, Ot as CircleQuestionMark, P as RefreshCcw, Qt as ArrowRight, T as ShieldCheck, U as MessageCircle, Zt as ArrowUpRight, a as Users, dt as FileText, en as ArrowDownRight, gt as EllipsisVertical, h as Trash2, ht as ExternalLink, m as TrendingUp, x as Sparkles } from "../_libs/lucide-react.mjs";
...
import { i as TableSkeleton, r as StatSkeleton } from "./Skeletons-COgUvsAH.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as DashboardShell } from "./DashboardShell-t2TYp7B0.mjs";
import { n as getClientDashboard } from "./profile.service-C-cGw1M0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/client.tableau-de-bord-CUXHUWwZ.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `.font-display { font-family: 'Space Grotesk', ui-sans-serif, system-ui, sans-serif; }` }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
					className: "font-display text-[30px] font-bold tracking-tight sm:text-[32px]",
					children: ["Bonjour", user ? `, ${user.displayName}` : ""]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1.5 text-[14px] text-muted-foreground",
					children: "Voici un aperçu de votre activité sur Sortlist."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: isStatsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatSkeleton, { count: 4 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircularStat, {
								icon: ShieldCheck,
								label: "Score de confiance",
								value: stats.trustScore,
								footer: stats.trustScoreLabel ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-2 py-0.5 text-[12px] font-semibold text-primary",
									children: stats.trustScoreLabel
								}) : null
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
								...
								footer: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeltaLabel, { value: stats.publishedProjectsDelta })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircularStat, {
								icon: TrendingUp,
								...
								isPercent: true,
								footer: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeltaLabel, { value: stats.responseRateDelta })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
								icon: Users,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "truncate text-[13.5px] font-bold tracking-wide text-muted-foreground",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "hidden grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1.1fr)_minmax(0,1.2fr)_auto] gap-4 border-b border-border bg-accent/40 px-5 py-3 lg:grid",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "mt-10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "text-[13.5px] font-bold tracking-wide text-muted-foreground",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-14 rounded-lg border border-border p-4",
...
function CircularStat({ icon: Icon, label, value, isPercent, footer }) {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "font-display text-[14px] font-bold " + tone.text,
					children: value === null ? "—" : `${value}${isPercent ? "%" : ""}`
				})
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "min-w-0",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "font-display mt-1 text-[28px] font-bold leading-none",
...
function ProjectRow({ project }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "grid grid-cols-1 gap-3 px-5 py-4 transition-colors hover:bg-accent/30 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1.1fr)_minmax(0,1.2fr)_auto] lg:items-center lg:gap-4",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "min-w-0",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[12.5px] font-semibold " + statusStyle,
			...
			canRepost || canDelete ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
				asChild: true,
			...
			})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "justify-self-start lg:justify-self-center" })
		]
	});
}
function QuickAction({ icon: Icon, title, description, to }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		to,
		className: "group flex flex-col gap-3 rounded-lg border border-border p-5 transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "flex items-center gap-1.5 text-[12.5px] font-semibold text-primary opacity-0 transition-opacity group-hover:opacity-100",
				children: ["Ouvrir", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
