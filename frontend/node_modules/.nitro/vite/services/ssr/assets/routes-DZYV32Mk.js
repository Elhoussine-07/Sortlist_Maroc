...
import { t as Footer } from "./Footer-ltp81XHe.js";
import { t as MarketingHeader } from "./MarketingHeader-CTcyVmuL.js";
import { useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Ban, Briefcase, CheckCircle2, ChevronLeft, ChevronRight, ClipboardCheck, Code2, Compass, Eye, FileText, Handshake, LifeBuoy, Megaphone, MessageSquare, Palette, Play, Rocket, Scale, Shield, Sparkles, Target, UserRound, Users, Users2, Wallet } from "lucide-react";
...
function HomePage() {
	const [openDemoSlug, setOpenDemoSlug] = useState(null);
	const countriesScrollRef = useRef(null);
	const demoFeature = ADVANTAGES.find((item) => item.slug === openDemoSlug) ?? null;
	return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-background",
		children: [
			/* @__PURE__ */ jsx(MarketingHeader, { variant: "landing" }),
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: TWO_ACTORS.map((actor) => /* @__PURE__ */ jsxs("div", {
								className: "rounded-lg border border-border p-6 sm:p-8",
								children: [
									/* @__PURE__ */ jsx(actor.icon, {
										className: "h-6 w-6",
										strokeWidth: 1.6
									}),
									/* @__PURE__ */ jsx("h3", {
									...
									/* @__PURE__ */ jsx("ul", {
										...
										children: actor.points.map((point) => /* @__PURE__ */ jsxs("li", {
									...
									/* @__PURE__ */ jsxs(Link, {
										...
										children: [actor.ctaLabel, /* @__PURE__ */ jsx(ArrowRight, {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: [/* @__PURE__ */ jsx("div", { className: "absolute left-[12.5%] right-[12.5%] top-[18px] hidden border-t border-dashed border-border sm:block" }), ADVANTAGES.map((item, index) => /* @__PURE__ */ jsxs("a", {
								href: "#" + item.slug,
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsx(FeatureDetail, {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: HOW_IT_WORKS.map((step, index) => /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							className: "mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3",
							children: COMMITMENTS.map((item) => /* @__PURE__ */ jsxs("div", {
								className: "rounded-lg border border-border p-6",
								children: [
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("div", {
									...
									children: [...SECTORS, ...SECTORS].map((sector, index) => /* @__PURE__ */ jsxs("div", {
										className: "flex w-[220px] shrink-0 flex-col rounded-lg border border-border p-5",
										children: [
											/* @__PURE__ */ jsx(sector.icon, {
												className: "h-6 w-6",
												strokeWidth: 1.6
											}),
											/* @__PURE__ */ jsx("h3", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: COUNTRIES.map((country) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Créer mon compte gratuitement", /* @__PURE__ */ jsx(ArrowRight, {
								className: "h-3.5 w-3.5",
								strokeWidth: 2
							})]
						}), /* @__PURE__ */ jsx(Link, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									children: DEMO_NAV.map((item) => /* @__PURE__ */ jsxs("p", {
										className: "flex items-center gap-2 text-[12.5px] font-medium",
										children: [/* @__PURE__ */ jsx("span", { className: "h-3 w-3 rounded-sm border border-border" }), item]
									}, item))
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "p-4",
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										className: "mt-4",
										children: /* @__PURE__ */ jsx(StackSkeleton, { count: 3 })
									})
								]
							})]
						}), /* @__PURE__ */ jsx(Link, {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full border border-border" }),
								/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full border border-border" }),
								/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full border border-border" }),
								/* @__PURE__ */ jsx("span", {
							...
							className: "p-4",
							children: /* @__PURE__ */ jsx(FeatureMock, { feature })
						})]
					}),
				...
				children: feature.benefits.map((benefit) => /* @__PURE__ */ jsxs("div", {
...
function FeatureMock({ feature }) {
	if (feature.mockType === "score") return /* @__PURE__ */ jsx("div", {
		className: "space-y-3",
		children: feature.mock.map((row) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
	...
	if (feature.mockType === "cards") return /* @__PURE__ */ jsx("div", {
		className: "space-y-2.5",
		children: feature.mock.map((row) => /* @__PURE__ */ jsxs("div", {
	...
	if (feature.mockType === "chat") return /* @__PURE__ */ jsx("div", {
		className: "space-y-2.5",
		children: feature.mock.map((row, index) => /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: feature.mock.slice(1).map((row) => /* @__PURE__ */ jsxs("div", {
