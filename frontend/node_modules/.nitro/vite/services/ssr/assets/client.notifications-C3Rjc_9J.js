import { a as markAsRead, i as markAllAsRead, n as getNotificationHistory, o as useNotificationsStore, r as getNotifications, t as DashboardShell } from "./DashboardShell-t2TYp7B0.js";
import { t as ApiError } from "./http-BM0VI1yy.js";
import { c as StatusTabs, r as SearchInput, s as StatusBadge } from "./Blocks-CStVFDlw.js";
import { n as ListPagination } from "./ListControls-FMqnx6XI.js";
import { t as DataTable } from "./DataTable-EspjDfBC.js";
		...
		},
		{
			...
			render: (notification) => {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [
						showViewProfile ? /* @__PURE__ */ jsx("a", {
						...
						notification.read ? null : /* @__PURE__ */ jsx("button", {
						...
						notification.read && !showViewProfile ? /* @__PURE__ */ jsx("span", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("label", {
						...
						}), TYPE_FILTERS.map((option) => /* @__PURE__ */ jsx("option", {
							value: option.value,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("p", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
						...
						}), isSortOpen ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
							...
							children: SORT_OPTIONS.map((option) => /* @__PURE__ */ jsx("button", {
								type: "button",
								onClick: () => {
