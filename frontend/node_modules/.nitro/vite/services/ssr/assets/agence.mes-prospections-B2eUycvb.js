...
import { r as getLeads } from "./prospection.service--95GQsSM.js";
import { useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { ChevronDown, Send } from "lucide-react";
//#region src/routes/_authenticated/agence.mes-prospections.tsx?tsr-split=component
var TABS = [
	{
		value: "all",
		label: "Toutes"
...
var COLUMNS = [
	...
	},
	{
		key: "status",
		header: "Statut",
		render: (item) => /* @__PURE__ */ jsx(StatusBadge, { label: item.temperatureLabel })
	},
	{
		key: "score",
		header: "Score",
		render: (item) => /* @__PURE__ */ jsxs("p", {
			className: "truncate text-[13px] text-muted-foreground",
