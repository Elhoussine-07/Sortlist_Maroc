...
import { l as searchProjects } from "./projects.service-BHaNpgMa.js";
import { S as toggleProjectFavorite, m as listFavoriteProjects, s as getCategories, t as EmptyState } from "./EmptyState-CjCsYQbe.js";
import { t as CardGridSkeleton } from "./Skeletons-COgUvsAH.js";
import { t as MarketingHeader } from "./MarketingHeader-CTcyVmuL.js";
import { useEffect, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { ArrowLeft, ArrowRight, Bookmark, ChevronDown, Clock, MapPin, Search, Tag, Wallet } from "lucide-react";
//#region src/routes/projets.tsx?tsr-split=component
function SearchProjectsPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(MarketingHeader, {
			variant: "search",
			active: "projects",
			applyDisabled: true
		}), /* @__PURE__ */ jsxs("main", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(FilterSelectOptions, {
							label: "Catégorie",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("p", {
						...
						children: ["Plus récents", /* @__PURE__ */ jsx(ChevronDown, {
				...
				/* @__PURE__ */ jsx("section", {
					className: "mt-6",
					children: isLoading ? /* @__PURE__ */ jsx(CardGridSkeleton, { count: 8 }) : projects.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucun projet à afficher." }) : /* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4",
						children: projects.map((project) => /* @__PURE__ */ jsxs("article", {
...
function Pagination({ page, totalPages, onChange }) {
	...
	return /* @__PURE__ */ jsxs("nav", {
		...
		children: [
			...
			visible.map((p) => /* @__PURE__ */ jsx("button", {
				type: "button",
				onClick: () => onChange(p),
			...
			pages > 5 ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: ["Suivant", /* @__PURE__ */ jsx(ArrowRight, {
					className: "h-3.5 w-3.5",
					strokeWidth: 1.8
				})]
			})
