...
//#region src/routes/fonctionnalites.$slug.tsx?tsr-split=component
var BENEFITS = [
	{
					...
					children: [/* @__PURE__ */ jsx(Target, {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", {
								...
								children: (feature ?? BENEFITS).map((benefit) => /* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									children: DEMO_NAV.map((item) => /* @__PURE__ */ jsxs("p", {
										...
										children: [/* @__PURE__ */ jsx("span", { className: "h-3.5 w-3.5 rounded-sm border border-border" }), item]
									}, item))
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "p-5",
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("p", {
											...
											children: [/* @__PURE__ */ jsx("span", { children: "Filtres (0)" }), /* @__PURE__ */ jsx("span", { children: "Trier par : Pertinence" })]
										})]
									}),
									/* @__PURE__ */ jsx("div", {
										className: "mt-5",
										children: isDemoLoading ? /* @__PURE__ */ jsx(StackSkeleton, { count: 3 }) : /* @__PURE__ */ jsxs("div", {
											className: "grid grid-cols-1 gap-6 sm:grid-cols-3",
											children: [demoAgencies.map(() => null), demoAgencies.length === 0 ? Array.from({ length: 3 }).map((_, index) => /* @__PURE__ */ jsxs("div", {
												className: "space-y-2",
												children: [
													/* @__PURE__ */ jsx("p", { className: "h-3.5 rounded bg-muted" }),
													/* @__PURE__ */ jsx("p", { className: "h-2.5 w-2/3 rounded bg-muted" }),
													/* @__PURE__ */ jsx("p", { className: "h-2.5 rounded bg-muted" }),
													/* @__PURE__ */ jsx("p", { className: "h-2.5 w-1/2 rounded bg-muted" }),
													/* @__PURE__ */ jsxs("div", {
														className: "flex items-center justify-between pt-4",
														children: [/* @__PURE__ */ jsx("p", { className: "h-2.5 w-24 rounded bg-muted" }), /* @__PURE__ */ jsx("span", { className: "flex h-8 w-8 items-center justify-center rounded-full border border-border text-[13px] font-semibold" })]
													})
												]
											}, index)) : null]
										})
