...
import { d as listAgencyMembers, f as listAgencyReviews, t as EmptyState } from "./EmptyState-CjCsYQbe.js";
import { i as SectionCard, l as TextAreaField, s as StatusBadge, t as FormSkeleton, u as TextField } from "./Blocks-CStVFDlw.js";
import { n as StackSkeleton } from "./Skeletons-COgUvsAH.js";
import { a as updateAgencyProfile, c as uploadFile, t as getAgencyProfile } from "./profile.service-C-cGw1M0.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { Check, Image, Loader2, Plus, Star, Trash2, Upload, X } from "lucide-react";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
//#region src/routes/_authenticated/agence.profil.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", {
			...
			children: [value ? /* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsx(Image, { className: "h-6 w-6 stroke-[1.5]" })
			}), /* @__PURE__ */ jsxs("label", {
				...
				children: [
					isUploading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin text-primary" }) : /* @__PURE__ */ jsx(Upload, { className: "h-4 w-4" }),
					/* @__PURE__ */ jsx("span", { children: value ? "Changer" : "Téléverser" }),
					/* @__PURE__ */ jsx("input", {
						type: "file",
						accept: "image/*",
						className: "hidden",
...
function SaveButton({ onClick, isPending, pendingLabel, label }) {
	return /* @__PURE__ */ jsxs("button", {
		...
		children: [isPending ? pendingLabel : /* @__PURE__ */ jsx(Check, {
			className: "h-3.5 w-3.5",
			strokeWidth: 2
...
var profileSchema = z.object({
	...
	description: z.string().trim().min(1, "Champ requis").max(2e3),
		...
		children: [/* @__PURE__ */ jsx("style", { children: `.font-display { font-family: 'Space Grotesk', ui-sans-serif, system-ui, sans-serif; }` }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					action: profile?.legalIdValid ? /* @__PURE__ */ jsx(StatusBadge, { label: "Identifiant légal vérifié" }) : null,
					children: isLoading ? /* @__PURE__ */ jsx(FormSkeleton, { fields: 6 }) : /* @__PURE__ */ jsxs("form", {
						onSubmit,
						className: "space-y-5",
						noValidate: true,
						children: [
							...
							/* @__PURE__ */ jsxs("button", {
								...
								className: "flex items-center gap-1.5 rounded-md bg-primary px-4 py-2.5 text-[13.5px] font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60",
								children: [updateMutation.isPending ? null : /* @__PURE__ */ jsx(Check, {
									className: "h-3.5 w-3.5",
									strokeWidth: 2
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: isLoading ? /* @__PURE__ */ jsx(StackSkeleton, { count: 2 }) : /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							services.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucun service renseigné." }) : null,
							services.map((service, index) => /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-1 gap-3 rounded-lg border border-border p-4 sm:grid-cols-2",
								children: [
									/* @__PURE__ */ jsx(ItemCardHeader, {
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: isLoading ? /* @__PURE__ */ jsx(StackSkeleton, { count: 3 }) : /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							portfolioItems.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucune réalisation renseignée." }) : null,
							portfolioItems.map((item, index) => /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-1 gap-3 rounded-lg border border-border p-4 sm:grid-cols-2",
								children: [
									/* @__PURE__ */ jsx(ItemCardHeader, {
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							team.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucun membre renseigné." }) : null,
							team.map((member, index) => /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-1 gap-3 rounded-lg border border-border p-4 sm:grid-cols-2",
								children: [
									/* @__PURE__ */ jsx(ItemCardHeader, {
									...
									/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
										...
										}), (membersQuery.data ?? []).map((option) => /* @__PURE__ */ jsxs("option", {
											value: option.id,
											children: [
												option.user,
												" (",
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							certifications.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucun certificat renseigné." }) : null,
							certifications.map((cert, index) => /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-1 gap-3 rounded-lg border border-border p-4 sm:grid-cols-2",
								children: [
									/* @__PURE__ */ jsx(ItemCardHeader, {
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: reviewsQuery.isPending ? /* @__PURE__ */ jsx(StackSkeleton, { count: 2 }) : (reviewsQuery.data ?? []).length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucun avis pour le moment." }) : /* @__PURE__ */ jsx("ul", {
						className: "space-y-4",
						children: (reviewsQuery.data ?? []).map((review) => /* @__PURE__ */ jsxs("li", {
				...
				/* @__PURE__ */ jsx(SectionCard, {
					...
					children: profile === null ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucune donnée disponible" }) : /* @__PURE__ */ jsxs("div", {
						className: "flex items-start gap-4",
						children: [profile.logo ? /* @__PURE__ */ jsx("img", {
							src: profile.logo,
							alt: profile.name,
